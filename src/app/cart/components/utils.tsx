...
export const FALLBACK_IMAGE = "/products/generic.svg"; // Use local SVG as fallback

// Cache for product images to avoid repeated API calls
export const productImageCache: Record<string, string> = {};
...
export function getDiscountForCode(cart: any, code: string): number {
